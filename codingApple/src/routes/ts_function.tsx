...
*/
  ...
  return (
    ...
    function 함수2(x :number) :void {
      ...
      <p>함수(30) : {함수(30)}</p>
      <p>
        함수에서 void 타입 활용 가능 : retrun할 자료가 없는 함수의 타입 return
        하려고할 때 에러를 낸다.
      </p>
      <h4>숙제1</h4>
      <p>
        이름을 파라미터로 입력하면 콘솔창에 "안녕하세요 홍길도 이라고
        출력해주기"
      </p>
      <pre>
        <code>
      ...
      <h4>숙제2 </h4>
      <p>
        함수에 숫자 또는 문자를 집어 넣으면 자릿수를 세어 출력해주는 함수 만들기
      </p>
